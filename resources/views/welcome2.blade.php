...
<head>
    ...
    <!--====== Title ======-->
    <title>Whistleblowing System Pemerintah Kota Banjarmasin</title>

    <!--====== Favicon Icon ======-->
    <link rel="shortcut icon" href="/wbs/assets/images/favicon.png" type="image/png">

    <!--====== Bootstrap css ======-->
    <link rel="stylesheet" href="/wbs/assets/css/bootstrap.min.css">

    <!--====== Line Icons css ======-->
    <link rel="stylesheet" href="/wbs/assets/css/LineIcons.css">

    <!--====== Magnific Popup css ======-->
    <link rel="stylesheet" href="/wbs/assets/css/magnific-popup.css">

    <!--====== Default css ======-->
    <link rel="stylesheet" href="/wbs/assets/css/default.css">

    <!--====== Style css ======-->
    <link rel="stylesheet" href="/wbs/assets/css/style.css">
...
<body>
    ...
    <header class="header-area">
                    ...
                    <div class="col-lg-12">
                        <nav class="navbar navbar-expand-lg">
                            <a class="navbar-brand" href="#">
                                <img src="/logo/pemko.png" width="75px" height="75px" alt="Logo">
                            </a>
                            ...
                            <div class="collapse navbar-collapse sub-menu-bar" id="navbarOne">
                                <ul class="navbar-nav m-auto">
                                    ...
                                    <li class="nav-item">
                                        <a class="page-scroll" href="#informasi">INFORMASI KRITERIA</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="page-scroll" href="#pengaduan">PENGADUAN</a>
                                    </li>
                                </ul>
                            </div>
        ...
        <div id="home" class="header-hero bg_cover" style="background-image: url(logo/bjm2.jpg)">
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-10 col-lg-10">
                        <div class="header-content text-center">
                            <h1 class="header-title" style="font-family: 'Poppins', sans-serif; font-weight:bold;color:white; text-shadow:4px 2px #0577fa">Whistleblowing System<br/> Pemerintah Kota Banjarmasin</h1>
                            <p class="text"  style="color:white; text-shadow:1px 1px #0577fa">Mari bersama-sama menciptakan Pemerintahan yang jujur dan bersih. Laporkan setiap pelanggaran yang terjadi di lingkungan kerja Pemerintah Kota Banjarmasin.</p>
                            <ul class="header-btn">
                                <li><a class="btn-one" rel="nofollow" href="#pengaduan"><img style="filter: drop-shadow(0 0 2.75rem rgb(251, 250, 250));" src="/logo/peluit.png" width="30%"></a></li>
                            </ul>
                        </div> <!-- header content -->
                    </div>
                </div> <!-- row -->
            ...
            <div class="header-shape">
                 <img src="/wbs/assets/images/header-shape.svg" alt="shape">
            </div>
        </div> <!-- header content -->
    </header>
    ...
    <section id="informasi" class="services-area" style="padding-top:10px; padding-bottom:10px">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
    ...
    <section id="kriteria" class="pricing-area">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <div class="section-title text-center pb-10">
                        <h4 class="title">KRITERIA PENGADUAN</h4>
                        <p class="text">Syarat/kriteria Laporan agar bisa diproses lebih lanjut</p>
                    </div> <!-- section title -->
                </div>
            </div> <!-- row -->
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-7 col-sm-9">
                    <div class="single-pricing mt-40">
                        <div class="pricing-header text-center">
                            <span class="price" style="font-size:40px; margin-top:0px;">1. What</span>
                            <p class="pricing-list" style="margin-bottom: 40px; margin-top:5px;"> Apa perbuatan berindikasi Tindak Pidana Korupsi/pelanggaran yang diketahui</p>
                        </div>
                ...
                <div class="col-lg-4 col-md-7 col-sm-9">
                    <div class="single-pricing pro mt-40">
                        ...
                        <div class="pricing-header text-center">
                            <span class="price" style="font-size:40px; margin-top:0px;">2. Who</span>
                            <p class="pricing-list" style="margin-bottom: 40px; margin-top:5px;"> Siapa yang bertanggungjawab/terlibat dan terkait dalam perbuatan tersebut</p>
                        </div>
                ...
                <div class="col-lg-4 col-md-7 col-sm-9">
                    <div class="single-pricing enterprise mt-40">
                        ...
                        <div class="pricing-header text-center">
                            <span class="price" style="font-size:40px; margin-top:0px;">3. Where</span>
                            <p class="pricing-list" style="margin-bottom: 40px; margin-top:5px;"> Dimana tempat terjadinya perbuatan tersebut dilakukan</p>
                        </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-7 col-sm-9">
                    <div class="single-pricing mt-40">
                        <div class="pricing-header text-center">
                            <span class="price" style="font-size:40px; margin-top:0px;">4. When</span>
                            <p class="pricing-list" style="margin-bottom: 40px; margin-top:5px;"> Kapan waktu perbuatan pelanggaran tersebut dilakukan</p>
                        </div>
                ...
                <div class="col-lg-4 col-md-7 col-sm-9">
                    <div class="single-pricing pro mt-40">
                        ...
                        <div class="pricing-header text-center">
                            <span class="price" style="font-size:40px; margin-top:0px;">5. How</span>
                            <p class="pricing-list" style="margin-bottom: 40px; margin-top:5px;"> Bagaimana cara perbuatan tersebut dilakukan (modus, cara, dan sebagainya)</p>
                        </div>
                ...
                <div class="col-lg-4 col-md-7 col-sm-9">
                    <div class="single-pricing enterprise mt-40">
                        ...
                        <div class="pricing-header text-center">
                            <span class="price" style="font-size:40px; margin-top:0px;">6. Evidence</span>
                            <p class="pricing-list" style="margin-bottom: 40px; margin-top:5px;"> Dilengkapi bukti permulaan (dokumen / gambar / rekaman) yang mendukung</p>
                        </div>
            ...
            <div class="row">
                <div class="col-lg-12 text-center">
                    <div class="section-title pb-10">
                        <h4 class="title">Tata Cara Pengaduan</h4>
                        <p class="text">Tata cara membuat pengaduan melalui WBS</p>
                    </div> <!-- section title -->
                </div>
            </div> <!-- row -->
            <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="services-content mt-40 d-sm-flex">
                                ...
                                <div class="services-content media-body">
                                    <h4 class="services-title">Isi Formulir Pengaduan</h4>
                                    <p class="text" style="text-align:justify">Klik menu "Pengaduan" yang terdapat pada bagian navigasi. Isi dan lengkapi formulir pengaduan yang telah disediakan. Apabila isian pengaduan sudah lengkap, tekan tombol "Kirim" untuk mengirim pengaduan Anda.</p>
                                </div>
                            </div> <!-- services content -->
                        </div>
    ...
    <section id="pengaduan" class="pricing-area" style="padding-bottom:20px; padding-top:40px">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <div class="section-title text-center pb-10">
                        <h4 class="title">Formulir pengaduan </h4>
                    </div> <!-- section title -->
                </div>
            </div> <!-- row -->
            <div class="row justify-content-center">
                    ...
                    <div class="contact-form">
                        <form class="contact-form" method="post" action="/sendwb" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="single-form form-group">
                                        <input type="text" name="nama_lengkap" placeholder="Nip Anda" required="required">
                                        <div class="help-block with-errors"></div>
                                    </div> <!-- single form -->
                                </div>
                                <div class="col-md-6">
                                    <div class="single-form form-group">
                                        <input type="text" name="telp" placeholder="telp" required="required">
                                        <div class="help-block with-errors"></div>
                                    </div> <!-- single form -->
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-12">
                                    <div class="single-form form-group">
                                        <textarea placeholder="aduan anda" name="aduan" required="required"></textarea>
                                        <div class="help-block with-errors"></div>
                                    </div> <!-- single form -->
                                </div>
                                <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                    <div class="single-form form-group text-center">
                                        <button type="submit" class="main-btn">Kirim Pengaduan</button>
                                    </div> <!-- single form -->
                                </div>
                            </div> <!-- row -->
                        </form>
...
<!-- Histats.com  START  (aync)-->
        <script type="text/javascript">var _Hasync= _Hasync|| [];
            _Hasync.push(['Histats.start', '1,4891316,4,424,112,75,00011111']);
            ...
            <noscript><a href="/" target="_blank"><img  src="//sstatic1.histats.com/0.gif?4891316&101" alt="" border="0"></a></noscript>
            <!-- Histats.com  END  -->
        </div>
    </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="copyright text-center">
                            <p class="text">Inspektorat Kota Banjarmasin</p>
                        </div>
                    </div>
                </div> <!-- row -->
            </div> <!-- container -->
    ...
    <!--====== jquery js ======-->
    <script src="/wbs/assets/js/vendor/modernizr-3.6.0.min.js"></script>
    <script src="/wbs/assets/js/vendor/jquery-1.12.4.min.js"></script>

    <!--====== Bootstrap js ======-->
    <script src="/wbs/assets/js/bootstrap.min.js"></script>
    <script src="/wbs/assets/js/popper.min.js"></script>

    <!--====== Ajax Contact js ======-->
    <script src="/wbs/assets/js/ajax-contact.js"></script>

    <!--====== Scrolling Nav js ======-->
    <script src="/wbs/assets/js/jquery.easing.min.js"></script>
    <script src="/wbs/assets/js/scrolling-nav.js"></script>

    <!--====== Validator js ======-->
    <script src="/wbs/assets/js/validator.min.js"></script>

    <!--====== Magnific Popup js ======-->
    <script src="/wbs/assets/js/jquery.magnific-popup.min.js"></script>

    <!--====== Main js ======-->
    <script src="/wbs/assets/js/main.js"></script>
